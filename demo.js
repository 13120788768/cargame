...
// image.src = 'res/cus/px.jpg'
// console.log('GameGlobal image= ' + GameGlobal.GameGlobal)
...
function draw() {
  setTimeout(function () {
    ...
    drawCar();
    drawHUD($.ctx, 500, 221, $.colors.hud);
